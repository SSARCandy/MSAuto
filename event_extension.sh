...
do
    send_request \
        ...
        "https://msattack.snkplaymore.info/event/extension/battle_start/?kpi1=$stage_id"  > /dev/null
    ...
    send_request \
        ...
        "https://msattack.snkplaymore.info/event/extension/battle_win/" > /dev/null
