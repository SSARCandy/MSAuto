...
do
    ...
    send_request \
        ...
        "https://msaapi.snkplaymore.info/event/marathon2nd/battle_start/?kpi1=$stage_id"  > /dev/null
    ...
    send_request \
        ...
        "https://msaapi.snkplaymore.info/event/marathon2nd/battle_win/" > /dev/null
